...
| Surface | Status |
|---|---|
| Harness | DeepSeek Harness `0.1.2-rc.1` (compatibilidad declarada para `>=0.1.2-rc.1 <0.2.0`); el plugin no escribe eventos de sesión propios - el host registra los eventos estándar tool/call + tool/result. |
| Node | `^22.19.0 \|\| >=24.0.0` |
