...
| Surface | Status |
|---|---|
| Harness | DeepSeek Harness `0.1.2-rc.1` (compatibilidade declarada para `>=0.1.2-rc.1 <0.2.0`); o plugin não grava eventos de sessão próprios - o host registra os eventos padrão tool/call + tool/result. |
| Node | `^22.19.0 \|\| >=24.0.0` |
