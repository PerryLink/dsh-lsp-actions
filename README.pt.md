...
| Surface | Status |
|---|---|
| Harness | DeepSeek Harness `0.1.2-alpha.5` (compatibilidade declarada para `>=0.1.0-rc.8 <0.2.0`); o plugin não grava eventos de sessão próprios - o host registra os eventos padrão tool/call + tool/result. |
| Node | `^22.19.0 \|\| >=24.0.0` |
