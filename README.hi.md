...
| Surface | Status |
|---|---|
| Harness | DeepSeek Harness `0.1.0-rc.8` (`>=0.1.0-rc.8 <0.2.0` के लिए अनुकूलता घोषित) |
| Node | `^22.19.0 \|\| >=24.0.0` |
...
यह प्रोजेक्ट [PerryLink](https://github.com/PerryLink) द्वारा अनुरक्षित [15 DeepSeek Harness प्लगइन्स](https://github.com/PerryLink) में से एक है। अगर यह आपकी मदद करता है, तो बाकी भी करेंगे:

| Plugin | One-liner |
|---|---|
| [dsh-mcp-panel](https://github.com/PerryLink/dsh-mcp-panel) | केवल-पठन MCP रनटाइम पैनल: /mcp कमांड + स्टेटस, टूल्स और एरर वाला Settings टैब |
| [dsh-doublecheck](https://github.com/PerryLink/dsh-doublecheck) | इंजीनियरिंग-अनुशासन गार्ड: आवश्यकताओं की जाँच, टेस्ट गेट, प्रतिकूल समीक्षा |
| [dsh-background-agents](https://github.com/PerryLink/dsh-background-agents) | Web UI साइडबार, संदेश और व्यवधान के साथ टिकाऊ बैकग्राउंड चाइल्ड एजेंट |
| **[dsh-lsp-actions](https://github.com/PerryLink/dsh-lsp-actions)** | language servers पर LSP डायग्नोस्टिक्स, फ़ॉर्मेटिंग, कम्प्लीशन, कोड एक्शन और रिनेम |
| [dsh-output-styles](https://github.com/PerryLink/dsh-output-styles) | Claude Code outputStyles-समतुल्य रनटाइम स्टाइल स्विचिंग |
| [dsh-checkpoint-rewind](https://github.com/PerryLink/dsh-checkpoint-rewind) | Claude Code /rewind-समतुल्य: स्नैपशॉट, सत्र फ़ोर्क, एक-चरण पुनर्स्थापन |
...
| [dsh-auto-review](https://github.com/PerryLink/dsh-auto-review) | अनुमोदन श्रृंखला पर द्वितीय-मॉडल ऑटो-समीक्षा, डिफ़ॉल्ट fail-closed |
| [dsh-memento](https://github.com/PerryLink/dsh-memento) | अनुमोदन-गेटेड क्रॉस-सत्र मेमोरी: ctx.memory seam + SQLite + memory टूल |
...
| [dsh-composer-history](https://github.com/PerryLink/dsh-composer-history) | web composer के लिए टर्मिनल-शैली इनपुट इतिहास: तीर, Ctrl+R खोज |
...
| [dsh-claude-move](https://github.com/PerryLink/dsh-claude-move) | Claude Code सत्र, मेमोरी, स्किल्स और CLAUDE.md को DSH में माइग्रेट करें |
