...
| Surface | Status |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.7-rc.2` (`>=0.1.2-rc.1 <0.2.0 \|\| >=0.1.5-alpha.1 <0.2.0 \|\| >=0.1.6-0 <0.2.0 \|\| >=0.1.7-0 <0.2.0` के लिए अनुकूलता घोषित); प्लगइन स्वयं कोई सत्र इवेंट नहीं लिखता - host मानक tool/call + tool/result इवेंट दर्ज करता है। प्रकाशित seam में अब भी केवल चार legacy ऑपरेशन हैं, इसलिए प्लगइन अपना क्लाइंट रखता है और पहली action कॉल पर वह vintage दर्ज करता है। 2026-09-25 को सत्यापित (दोहरा typecheck + पूरी टेस्ट सूट + self-contained/artifacts गेट)। |
| Node | `^22.19.0 \|\| >=24.0.0` |
